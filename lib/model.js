...
(function () {
    ...
    this.addOptions = function (options, overwrite) {
        if (!underscore.isObject(options)) return;
        var newOptions = Object.keys(options);
        newOptions.forEach(function (name) {
            if (!this.options.hasOwnProperty(name) || overwrite) {
