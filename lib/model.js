...
(function () {
    ...
    this.create = function (value, opts) {
        ...
        //works recursively
        model.loadData = function (value, process, processFlags) {
            ...
            if (Array.isArray(meta.defs)) {
                ...
                Object.keys(value).forEach(function (key) {
                    ...
                    processFlags.forEach(function (pflag) {
                    ...
                    if (def.hasOwnProperty('collection')) {
                        ...
                        meta.data[mapkey].loadData(value[key], process, processFlags);
                    } else {
                        meta.isEmpty = false;
                        if (processIn) {
        ...
        model.toJSON = function (opts) {
            ...
            Object.keys(meta.defs).forEach(function (field) {
                ...
                opts.processFlags.forEach(function (pflag) {
                    if (def.hasOwnProperty('processors') && typeof def.processors[pflag] === 'function') {
        ...
        if (typeof value !== 'undefined') {
            model.loadData(value, undefined, opts.processFlags);
        }
